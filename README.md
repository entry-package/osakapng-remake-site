...
2026-09-14追記：全体デザインの確認を受け、トップ画像を「タコペンが大阪を観光する」イラストへ差し替えました。地図とカメラを持つタコペンを主役とし、元ロゴをキャラクターの参照に使用。旧画像は保存し、変更はヒーロー画像と代替テキストに限定しています。生成条件は `content/takopen-hero-20260914.json` を参照。
